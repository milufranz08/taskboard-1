  ...
  <div class="col-6 col-md-4">
    <div class="form-group">
    	<label for="task_name">Task Name</label>
   		<input type="tname" name="task_name" class="form-control" value="<?php echo $task_name?>" required>
  	</div>
  	<div class="form-group">
    	<label for="Textarea">Description</label>
    	<textarea class="form-control" name="task_desc" id="task_desc" rows="3" required><?php echo $task_description?></textarea>
  	</div>
  	<div class="form-group">
    	<label for="Textarea">Notes</label>
    	<textarea class="form-control" name="task_notes" id="task_notes"  rows="3"><?php echo $task_notes?></textarea>
 	</div>
  </div>
  <div class="col-6 col-md-2">
    ...
    <div class="col-6 col-md-2">
  	<?php if($team_lead_status == 'Y'):?>
  	  	...
  	  	<select class="form-control" id="inlineFormCustomSelect" name="task_assigned_to">
  	...
  	<?php endif;?>
  		...
  		<input type="submit" name="submit" value="Start Task" class="button-link" onclick="myFunction1()"><br><br><br>
  		<input type="submit" name="submit" value="Update Task" class="button-link"><br><br><br>
  		<input type="submit" name="submit" value="Complete Task" class="button-link" onclick="myFunction3()">
  	</div>
</div>
</form>
</div>
