...
<h1 align="center">All Projects<br><br></h1>
		...
		<?php foreach ($projects as $row):?>
						<?php if($row->task_assigned_to == $_SESSION['user_id'] && $row->task_assigned_to != NULL || $row->project_created_by == $_SESSION['user_id']):?>
							...
							<taskTickets>
		  							<div class="btn-group role="group">
		    								...
		    								<a href="<?php echo site_url()?>/Project/manage_project/<?php echo $row->project_id?>
